    ...
    $(document).ready(function () {
        ...
        if (window_width > 992) {
            ...
            $(body).on("mouseenter", ".menu-subline .menu-cnt > ul li", function () {
                $(nav).find(".subline-bar ul").removeClass("active").eq($(this).indexx11()).addClass("active");
            });
            ...
            $(body).on("click", ".menu-cnt > ul > li > a,.lan-menu a", function () {
                ...
                if ($(nav).hasClass("menu-subline")) {
                    ...
                    if (!active) {
                        $(nav).find(".subline-bar ul").removeClass("active").eq($(li).indexx11()).addClass("active");
                    }
                }
            });
        ...
        $(body).on("click", ".album-box", function () {
            ...
            $(album).find(".album-item").removeClass("active " + animation).eq($(this).indexx11()).addClass("active").showAnima(animation);
        });
